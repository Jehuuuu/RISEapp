...
const navItems = [
  { href: '/developer/dashboard', icon: DashboardIcon, label: 'Dashboard' },
  { href: '/developer/projects', icon: BusinessIcon, label: 'Projects' },
  { href: '/developer/analytics', icon: AnalyticsIcon, label: 'Analytics' },
...
export default function DeveloperLayout({
  ...
  if (!isAuthenticated || !currentUser || currentUser.role !== 'developer') {
    return null
  }
