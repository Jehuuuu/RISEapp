...
const navItems = [
  { href: '/investor/dashboard', icon: HomeIcon, label: 'Home' },
  { href: '/investor/browse', icon: SearchIcon, label: 'Browse' },
  { href: '/investor/portfolio', icon: AccountBalanceWalletIcon, label: 'Portfolio' },
...
export default function InvestorLayout({
  ...
  if (!isAuthenticated || !currentUser || currentUser.role !== 'investor') {
    return null
  }
